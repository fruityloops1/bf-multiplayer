...
typedef int8_t n8; ///<   8-bit signed integer.
typedef int16_t n16; ///<  16-bit signed integer.
typedef int32_t n32; ///<  32-bit signed integer.
typedef int64_t n64; ///<  64-bit signed integer.
typedef __int128_t n128; ///< 128-bit unsigned integer.
