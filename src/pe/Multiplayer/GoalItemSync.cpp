...
HkTrampoline<void, GoalItem*> goalItemCollectNrvHook = hk::hook::trampoline([](GoalItem* thisPtr) {
    goalItemCollectNrvHook.orig(thisPtr);
...
HkTrampoline<void, GameDataHolderWriter, bool> setPhaseEndHook = hk::hook::trampoline([](GameDataHolderWriter writer, bool isEnd) {
    setPhaseEndHook.orig(writer, isEnd);
...
{
    goalItemCollectNrvHook.installAtOffset(hk::ro::getMainModule(), 0x00243e60);
    setPhaseEndHook.installAtOffset(hk::ro::getMainModule(), 0x00420060);

    hk::hook::writeBranchLink(hk::ro::getMainModule(), 0x0025cbfc, setScenarioIDHook);
    hk::hook::writeBranchLink(hk::ro::getMainModule(), 0x0025cd5c, setScenarioIDHook);
    hk::hook::writeBranchLink(hk::ro::getMainModule(), 0x0025d0e4, setScenarioIDHook);
}
