...
HkTrampoline<nvn::GenericFuncPtrFunc, const char*> nvnBootstrapHook = hk::hook::trampoline([](const char* funcName) {
...
void nvnImGui::InstallHooks()
{
    ...
    hk::hook::writeBranchLink(hk::ro::getMainModule(), 0x0075d270, cmdBufInit); // agl::DisplayList::beginDisplayList
}
