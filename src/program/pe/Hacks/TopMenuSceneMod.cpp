...
struct Hooks {
    ...
    HOOK_DEFINE_TRAMPOLINE(TopMenuSceneSingleModeTitle) { static void Callback(TopMenuSceneExt * thisPtr); };
};

void Hooks::TopMenuSceneSingleModeTitle::Callback(TopMenuSceneExt* thisPtr)
{
...
HOOK_DEFINE_TRAMPOLINE(TopMenuSceneAppear) { static void Callback(TopMenuSceneExt * thisPtr, TopMenuAppearState state, bool thing); };

void TopMenuSceneAppear::Callback(TopMenuSceneExt* thisPtr, TopMenuAppearState state, bool thing)
{
    Orig(thisPtr, state, thing);
...
void installTopMenuSceneMod()
{
    ...
    Patcher(0x003fad48).BranchLinkInst((void*)initLayoutHook);
    Patcher(0x00404acc).Write(exl::armv8::inst::Movz(exl::armv8::reg::W0, sizeof(TopMenuSceneExt)));
    Patcher(0x003fad4c).Write(exl::armv8::inst::Movz(exl::armv8::reg::W0, sizeof(TopMenuExt)));
    Patcher(0x003fad6c).BranchLinkInst((void*)layoutConstructor);

    Patcher(0x003fb350).BranchInst((void*)Hooks::setWarningNrv);
    Patcher(0x003fb368).BranchInst((void*)Hooks::setWarningNrv);
    Patcher(0x003fbb8c).BranchInst((void*)Hooks::setWarningNrv);
    Patcher(0x0019f17c).BranchLinkInst((void*)Hooks::setCharSelectNerve);
    Patcher(0x0019f4e0).BranchInst((void*)Hooks::setCharSelectNerveReturnFromFileSelect);
    Patcher(0x0019f0b0).BranchInst((void*)Hooks::setCharSelectNerveFromEmptySave);
    Patcher(0x0019eebc).BranchInst((void*)Hooks::setModeSelectNerve);
    Patcher(0x0019f07c).WriteInst(exl::armv8::inst::Nop());
    Patcher(0x0019ee40).BranchLinkInst((void*)Hooks::firstStepAppearSingleModeButtons);
    Patcher(0x0019f0b8).BranchLinkInst((void*)Hooks::onSingleModeTitleLeave);

    TopMenuSceneAppear::InstallAtOffset(0x003fae60);
    Hooks::TopMenuSceneSingleModeTitle::InstallAtOffset(0x003fb4f0);
