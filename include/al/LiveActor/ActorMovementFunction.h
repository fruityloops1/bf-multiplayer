...
void rotateQuatLocalDirDegree(LiveActor* actor, int axis, float degrees);
void rotateQuatLocalDirDegree(LiveActor* actor, const sead::Quatf& base, int axis, float degrees);
