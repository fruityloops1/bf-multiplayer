...
class LayoutActor : public IUseHioNode,
    ...
    LayoutKeeper* mLayoutKeeper = nullptr;
...
void initLayoutActor(LayoutActor*, const LayoutInitInfo&, const char* archiveName, const char* = nullptr);
...
void hidePane(IUseLayout* user, const char* paneName);
void showPane(IUseLayout* user, const char* paneName);
void setPaneString(IUseLayout* user, const char* paneName, const char16_t* text, u16 = 0, int = 0);
void setPaneLocalTrans(IUseLayout* user, const char* paneName, const sead::Vector2f& trans);
void setPaneLocalScale(IUseLayout* user, const char* paneName, const sead::Vector2f& scale);
void setPaneLocalAlpha(IUseLayout* user, const char* paneName, float alpha);
